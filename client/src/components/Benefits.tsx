  ...
  return (
    <section id="beneficios" className="py-20 md:py-28 bg-gradient-to-br from-neutral-50 to-white">
      <div className="container">
        ...
        {/* CTA Section */}
        <div className="mt-12 p-8 md:p-10 rounded-2xl bg-gradient-to-r from-neutral-50 to-neutral-100 text-center">
          <h3 className="text-2xl md:text-3xl font-bold mb-3 text-neutral-900">Pronto para transformar seu negócio?</h3>
          <p className="text-base md:text-lg mb-6 text-neutral-700 max-w-2xl mx-auto">
