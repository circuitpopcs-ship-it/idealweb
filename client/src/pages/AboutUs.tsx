    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="bg-white border-b border-gray-200 py-12">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-neutral-900">Sobre a IdealWeb</h1>
          <p className="text-neutral-600 mt-4">Conheca a história por trás de nossas soluções digitais</p>
        </div>
      </div>
      ...
      <div className="container py-16 flex-grow">
        ...
        <section className="mb-20 max-w-3xl mx-auto">
          ...
          <p className="text-lg text-neutral-900 leading-relaxed mb-4">
            ...
            {values.map((value, idx) => {
              ...
              return (
                <div key={idx} className="p-8 rounded-lg border border-neutral-200 hover:shadow-lg transition-all">
                  ...
                  <p className="text-neutral-900 leading-relaxed">{value.description}</p>
                </div>
              );
            })}
          </div>
        ...
        <section className="mb-20 max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-neutral-900">Projetos entregues no prazo com qualidade garantida.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-neutral-900">Soluções inovadoras e personalizadas para seu negócio.</p>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-primary-blue mb-4">📈</div>
              <h3 className="text-xl font-bold text-neutral-900 mb-2">Resultados</h3>
              <p className="text-neutral-900">Focamos em conversão e crescimento do seu negócio.</p>
            </div>
          </div>
        </section>
