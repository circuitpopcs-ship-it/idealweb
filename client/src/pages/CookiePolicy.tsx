    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="bg-white border-b border-gray-200 py-12">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-neutral-900">Política de Cookies</h1>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-neutral-900">Configurações → Privacidade e segurança → Cookies e outros dados do site</p>
              </div>
              <div>
                <h3 className="text-lg font-bold text-neutral-900 mb-2">Mozilla Firefox</h3>
                <p className="text-neutral-900">Opções → Privacidade → Cookies e dados do site</p>
              </div>
              <div>
                <h3 className="text-lg font-bold text-neutral-900 mb-2">Safari</h3>
                <p className="text-neutral-900">Preferências → Privacidade → Gerenciar dados do site</p>
              </div>
              <div>
                <h3 className="text-lg font-bold text-neutral-900 mb-2">Microsoft Edge</h3>
                <p className="text-neutral-900">Configurações → Privacidade, pesquisa e serviços → Cookies e outros dados do site</p>
              </div>
            </div>
          </section>
